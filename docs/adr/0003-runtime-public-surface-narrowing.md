...
Status: Refined by [0004 - Runtime session lifecycle entrypoints](0004-runtime-session-lifecycle-entrypoints.md), [0005 - Built-in provider-only runtime](0005-built-in-provider-only-runtime.md), and [0008 - Single-candidate provider selection](0008-single-candidate-provider-selection.md). ADR 0008 is the current provider-selection decision.
